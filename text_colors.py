...
FLAGS_DICT: Dict[str, str] = {
    # ANSI STANDARD ATTRIBUTES - NOT ALL WIDELY SUPPORTED
    # Most do not work on my MacBook ... commented them out
    "NONE": "",
    "RESET": "\u001b[0m",  # Reset / Normal        all attributes off
    "BOLD": "\u001b[1m",  # Bold
    "DIM": "\u001b[2m",  # Dim                   NWS
    "ITALIC": "\u001b[3m",  # Italic                Sometimes Inverse
    "UNDER": "\u001b[4m",  # Underline
